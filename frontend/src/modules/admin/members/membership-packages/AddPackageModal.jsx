...
const AddPackageModal = ({ isOpen, onClose, isDarkMode, onSuccess }) => {
        ...
        try {
            ...
            if (res.ok) {
                setAlert({
                    ...
                    message: 'The membership package has been created successfully.'
                });
                ...
                setAlert({
                    ...
                    message: err.message || 'Failed to create package. Please try again.'
                });
            }
        } catch (error) {
