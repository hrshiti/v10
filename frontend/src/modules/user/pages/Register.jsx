...
const Register = () => {
    ...
    const handleRegister = (e) => {
        e.preventDefault();
        // In a real app, you'd validate and send data to backend here
        if (mobile && name) {
            navigate('/verify-otp', { state: { mobile, type: 'register' } });
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#121212] font-sans w-full max-w-md mx-auto relative shadow-2xl overflow-hidden ring-1 ring-gray-200 dark:ring-gray-800 transition-colors duration-300 flex flex-col justify-center px-6">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-64 h-64 bg-emerald-400/20 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="w-full max-w-md z-10 relative">
                <div className="mb-8 text-center pt-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Sign up to start your fitness journey</p>
                </div>
