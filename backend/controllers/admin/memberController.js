    ...
    const pipeline = [
        ...
        // 🔥 Dynamic Status Computation
        {
            $addFields: {
                computedStatus: {
                    $cond: [
                        { $not: ["$currentSubscription"] },
                        "$status",
                        {
                            $cond: [
                                { $lt: ["$currentSubscription.endDate", today] },
                                "Expired",
                                {
                                    $cond: [
                                        { $gt: ["$currentSubscription.startDate", today] },
                                        "Upcoming",
                                        "Active"
                                    ]
                                }
...
// });
// 03-03-2026 update the code -> mayur chadokar 
