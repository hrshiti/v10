    ...
    schedule: [
        ...
        },
        {
            ...
            exercises: [
                ...
                { category: "Back", exercise: "Barbell Bent Over Row", sets: 3, reps: "15, 12, 10" },
        ...
        },
        {
            ...
            exercises: [
                ...
                { category: "Biceps", exercise: "Zottman Curl", sets: 3, reps: "15, 12, 10" },
        ...
        },
        {
            ...
            exercises: [
                ...
                { category: "Triceps", exercise: "One Arm Lying Triceps Extension", sets: 3, reps: "15, 12, 10" },
                { category: "Triceps", exercise: "Close Grip Dumbbell Press", sets: 3, reps: "15, 12, 10" },
...
async function seedWorkout() {
    try {
        ...
        console.log("✅ Successfully added Workout: Weight Gain Level 2 (New)");
        process.exit(0);
    } catch (error) {
